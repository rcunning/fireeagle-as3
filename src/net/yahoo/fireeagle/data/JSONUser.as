...
package net.yahoo.fireeagle.data
{
	 ...
	 * 
	 */
	public class JSONUser extends JSONObject implements IFireEagleUser
	{
		/**
		...
		/**
		 * An array of <code>JSONLocation</code> object if parsed from the user location_hierarchy.
		 */
		protected var _locations:Array;
		
		/**
		 * Creates a new <code>JSONUser</code> object.
		 * @param obj		JSON object to parse
		 */
		public function JSONUser(obj:Object)
		{
			super(obj);
		}
		...
		{
			if (_locations == null) {
				_locations = parseToArray(data, "location_hierarchy", JSONLocation);
			}
			return _locations;
		}
